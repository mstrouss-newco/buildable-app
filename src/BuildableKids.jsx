...
const LANDING_WRAP = {
  ...
  skyflyer: { play: SCREEN_SKYFLYER, loadout: true, journey: true, demo: "/skyflyer-engine.html?v=ar1g&screen=demo" },
...
function SkyFlyerScreen({ onHome, level }) {
  ...
  const src = "/skyflyer-engine.html?v=ar1g&ride=" + ride + (level != null ? "&level=" + level : "");
