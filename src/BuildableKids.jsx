...
function FarmScreen({ onHome, level }) { return <GameFrame title="The Farm" src={"/skyflyer-farm.html?v=fm18" + (level != null ? "&level=" + level : "")} onHome={onHome} bg="#B3E58C" iframeProps={{ onLoad: (e) => { try { e.currentTarget.contentWindow.focus(); } catch (_) {} } }} />; }
