...
const LANDING_WRAP = {
  ...
  skyflyer: { play: SCREEN_SKYFLYER, loadout: true, journey: true, demo: "/skyflyer-engine.html?v=ar1m&screen=demo" },
...
function SkyFlyerScreen({ onHome, level }) {
  ...
  const src = "/skyflyer-engine.html?v=ar1m&ride=" + ride + (level != null ? "&level=" + level : "");
