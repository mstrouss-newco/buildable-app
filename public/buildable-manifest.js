...
(function(root){
  ...
  // ---- profile registry -----------------------------------------------------
  var PROFILES = { breaker: breakerProfile, survival: survivalProfile, sling: slingProfile, studio: studioProfile, chess: chessProfile, board: boardProfile, checkers: boardProfile, tictactoe: boardProfile, connectfour: boardProfile, croc: crocProfile, croctot: crocProfile, "rileys-garden": crocProfile };
