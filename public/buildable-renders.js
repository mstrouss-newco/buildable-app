...
(function (g) {
  ...
  BR.puIcon = function (ctx, id, x, y, P) {
    ...
    else if (id === "storm") { ctx.fillStyle = "#bfe0ff"; ctx.strokeStyle = "#7fd0ff"; ctx.lineWidth = 2; ctx.beginPath(); ctx.moveTo(4, -20); ctx.lineTo(-9, 3); ctx.lineTo(-1, 3); ctx.lineTo(-5, 20); ctx.lineTo(12, -6); ctx.lineTo(3, -6); ctx.closePath(); ctx.fill(); ctx.stroke(); }
