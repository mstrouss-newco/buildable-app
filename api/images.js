...
function build(q) {
  ...
  if (kind === "tennis") {
    const id = (q.id || "").toString();
    // Smooth painterly nature backdrops for the tennis court. Each id maps to the
    // world's DISPLAY NAME (see tennis.html GAME_CONFIG.worlds). Absolutely NOT pixel art.
    const COURT_STYLE = "Soft painterly children's storybook nature landscape, smooth gradients and gentle brushwork, warm cinematic lighting, calm and beautiful, high-resolution smooth digital painting (absolutely NOT pixel art — no pixelation, no visible pixels, no 8-bit, no retro, no dithering), a wide open calm sky filling the upper half and scenery framing the lower edges, no people, no characters, no text, no words, no letters, no UI, no tennis court, no net, no ball, child-friendly ages 4-8";
    const COURTS = {
      beach:   "A tranquil tropical seaside at golden hour: calm turquoise ocean meeting a soft sandy shore, a few gentle palm trees leaning in from the sides, a couple of distant sailboats, a warm sun low on the horizon, soft fluffy clouds",   // "Seaside"
      space:   "A serene arctic night sky glowing with green and violet northern lights (aurora borealis) rippling over a calm dark horizon, sparkling stars, a faint snowy tundra along the bottom, peaceful and magical",                          // "Northern Lights"
      jungle:  "A lush green tropical jungle with one enormous ancient tree rising in the center, big leafy fronds and hanging vines framing the sides, soft dappled sunlight, glowing tropical flowers, warm misty air",                            // "Big Tree"
      ocean:   "A calm evergreen pine forest beside a still mountain lake, tall pine trees framing the sides, soft mist drifting between the trunks, a gentle blue-grey morning sky, cool and peaceful",                                             // "Pine Forest"
      candy:   "A bright sunny wildflower meadow rolling into soft green hills, colorful flowers and tall grass swaying, a big cheerful sun, fluffy white clouds in a clear blue sky, warm and joyful",                                             // "Sunny Meadow"
      snow:    "A majestic snowy mountain peak under a crisp clear blue sky, glittering fresh snow, a few frosted pine trees along the lower edges, gentle falling snowflakes, cool and serene",                                                    // "Snowy Peak"
      volcano: "Tall dramatic layered stone cliffs and rocky bluffs under a bright sky, warm sandstone rock formations framing the sides, a calm sea far below, soft golden afternoon light, grand and peaceful",                                  // "Stone Cliffs"
      city:    "Gently rolling emerald-green hills under a big blue sky, soft warm sunlight, a winding grassy path, a few scattered round leafy trees, fluffy white clouds, calm cheerful countryside",                                            // "Green Hills"
    };
