...
const stable = JSON.stringify({color: entity.color || "",body: entity.body || "",feature: entity.feature || "",power: entity.power || "",style: entity.style || "",accessory: entity.accessory || ""});
