...
const SOUNDS = {
  ...
  mahjong_combo:   "Short exciting magical sparkle whoosh with a fast rising twinkle and a bright celebratory pop, a big combo streak, single hit, no music, no voices",
  ...
  mahjong_win:     "Warm rewarding cheerful victory jingle: a bright sparkly fanfare rising up with a shimmer flourish and a soft happy children yay cheer, satisfying puzzle-cleared celebration, no words",
...
const DURATIONS = {
  ...
  mahjong_pick:0.5, mahjong_match:0.6, mahjong_match2:0.7, mahjong_match3:0.8, mahjong_combo:0.9, mahjong_nope:0.5, mahjong_shuffle:0.7, mahjong_win:2.0,
